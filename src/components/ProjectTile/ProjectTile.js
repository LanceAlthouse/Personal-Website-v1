...
const ProjectTile = (props) => {
  return (
    <div className="rounded-2xl w-80 h-[124] text-white px-[1px] py-[1px] bg-gradient-to-r from-green-600 to-fuchsia-900 hover:scale-110 ease-in duration-300 shadow-lg shadow-black">
