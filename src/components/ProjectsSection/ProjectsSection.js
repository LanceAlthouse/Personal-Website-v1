...
const Projects = () => {
  return (
    <div className="font-mono font-medium Consolas ">
      <h1 className="font-bold text-3xl text-white text-center underline pt-6">
        Projects
      </h1>
      <div className="flex flex-wrap items-center justify-center grid-cols-5 grid-rows-5 gap-16 p-16 h-[650px]">
        <ProjectTile
